...
The Driver based module is an operational input module used to plan values based on **drivers** such as quantities, volumes, prices, or FTE.

Input is transformed into P&L transactions and returned to the Plan Overview workbook as a work-in-progress P&L.
...
Measures are rendered as rows in the model.
...
**Source data**
- New dimension combinations from source fact data are added automatically
...
Modules are attached to **Plan Overview** report lines using ranked department selection.
