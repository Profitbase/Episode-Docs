...
| Display Order Expression    | A C# expression that returns an integer to define the column's display order, overriding the default schema arrangement. The expression supports parameters and Directives. |
